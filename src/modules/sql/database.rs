...
pub use super::files::{
    ...
    is_directory_indexed, mark_directory_error, mark_directory_traversed,
    mark_directory_traversed_and_modified, set_directory_size, upsert_file, DirectoryMetadata,
    UpsertResult,
};
